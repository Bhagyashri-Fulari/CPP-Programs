...
class ArrayX
{
    public:
        ...
        bool BiDirectionalSearch(int no)  //  n/2
        {
            ...
            for(iStart = 0, iEnd = iEnd - 1; iStart <= iEnd; iStart++, iEnd--)
            {
...
int main()
{
    ...
    bRet = aobj -> CheckSortedDec();

    if(bRet == true)
    {
        cout<<"Data is sorted in decreasing order\n";
    }
    else
    {
        cout<<"Data is not sorted in decreasing order\n";
    }
